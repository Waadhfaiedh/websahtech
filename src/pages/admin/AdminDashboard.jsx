            ...
            <div className="space-y-3">
              {recentActivity.map((act) => (
                <div key={act.id} className="flex items-center gap-3">
                  <div
                    className={`w-2.5 h-2.5 rounded-full flex-shrink-0 ${act.color}`}
                  />
            ...
            <div className="mt-6 pt-4 border-t border-gray-100">
              ...
              {data?.specialist?.data?.slice(0, 4).map((sp) => (
                <div key={sp.userId} className="flex items-center gap-2 mb-2">
                  <div
                    className={`w-6 h-6 ${sp.specialist?.isValidated ? "bg-green-100" : "bg-orange-100"} rounded-full flex items-center justify-center`}
                  >
                    <span
                      className={`${sp.specialist?.isValidated ? "text-green-600" : "text-orange-600"} text-xs font-bold`}
                    >
